...
def parseHyperparams():
    ...
    parser.add_argument("--input_size", type=int, default=784, help="Input size of the network (default : 784)")
    parser.add_argument("--middle_width", type=int, default=1024, help="Width of the middle layer (default : 2000)")
